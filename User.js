...
<Link to="/"><Button
  ...
  <ul  >
   <Link to="/Suba1"> <li  >Find Doctors</li></Link>
    <Link to="/Ranjith"><li >Book Appointment</li></Link>
    <Link to="/About"><li>About Us</li></Link>
  </ul>
</div>
               <div className='adv'>
                <img src={ad} alt='ad' className='hvr-float' height='400px' width='950px'></img></div>
                <Link to="/Suba1"><div className='rec'></div>
                <Tooltip title="Click to Find Doctors " ><img src={findDoctor} alt='Find Doctors' className='FindDoc' height='300px' width='280px'/>
                </Tooltip>
                
<h1 className='fd'>Find Doctors Near You</h1></Link>
<div class="lietext">
...
your Specifications
 with ease. </h3>
                ...
                <div style={brdgd} >
                  <Link to="/Ranjith"> <div className='rec1'>
                  <Tooltip title="Click to Book Appointment"><img src={appoint} alt='appointment' className='Ap' height='300px' width='280px'/>
                  </Tooltip>
