...
const ProjectLogin=()=>{
        ...
        return(
            ...
            <Link to="/project"><h4 style={{marginLeft:"270px",marginTop:"-20px",fontSize:"15px",
              color:"blue",position:"absolute",top:"82.5%",left:"2%"}}>Create Account</h4></Link>        
            <Link to="/Doctor"> <button className="cob" style={{background:"blue",color:"white",
